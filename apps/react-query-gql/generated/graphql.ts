...
export const useLaunchQuery = <
    ...
    >(
      ...
      options?: UseQueryOptions<LaunchQuery, TError, TData>
    ) =>
    useQuery<LaunchQuery, TError, TData>(
      ['Launch', variables],
      fetcher<LaunchQuery, LaunchQueryVariables>(LaunchDocument, variables),
      options
    );
export const useInfiniteLaunchQuery = <
      TData = LaunchQuery,
      TError = unknown
    >(
      pageParamKey: keyof LaunchQueryVariables,
      variables: LaunchQueryVariables,
      options?: UseInfiniteQueryOptions<LaunchQuery, TError, TData>
    ) =>
    useInfiniteQuery<LaunchQuery, TError, TData>(
      ['Launch.infinite', variables],
      (metaData) => fetcher<LaunchQuery, LaunchQueryVariables>(LaunchDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );
...
export const useInfiniteLaunchesQuery = <
      TData = LaunchesQuery,
      TError = unknown
    >(
      pageParamKey: keyof LaunchesQueryVariables,
      variables?: LaunchesQueryVariables,
      options?: UseInfiniteQueryOptions<LaunchesQuery, TError, TData>
    ) =>
    useInfiniteQuery<LaunchesQuery, TError, TData>(
      variables === undefined ? ['Launches.infinite'] : ['Launches.infinite', variables],
      (metaData) => fetcher<LaunchesQuery, LaunchesQueryVariables>(LaunchesDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );
